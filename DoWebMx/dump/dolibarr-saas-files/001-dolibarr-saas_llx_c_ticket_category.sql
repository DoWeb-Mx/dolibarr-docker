...
CREATE TABLE `llx_c_ticket_category` (
  ...
  `force_severity` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `llx_c_ticket_category` VALUES (1,1,'OTHER','Other',1,1,0,NULL,NULL,10,1);
