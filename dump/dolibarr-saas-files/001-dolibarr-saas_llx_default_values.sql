...
CREATE TABLE `llx_default_values` (
  ...
  `param` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `llx_default_values` VALUES (1,1,'createform',0,'comm/action/card.php','complete','na');
