...
CREATE TABLE `llx_product_fournisseur_price` (
  ...
  `desc_fourn` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `supplier_reputation` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
