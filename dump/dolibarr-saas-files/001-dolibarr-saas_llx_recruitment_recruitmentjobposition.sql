...
CREATE TABLE `llx_recruitment_recruitmentjobposition` (
  ...
  `email_recruiter` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fk_user_supervisor` int DEFAULT NULL,
  `fk_establishment` int DEFAULT NULL,
  `date_planned` date DEFAULT NULL,
  `remuneration_suggested` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
